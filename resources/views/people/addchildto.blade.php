                    ...
                    <div class="card-started" id="home-card">
                        ...
                        <div class="row m-2">
                            <div class="mb-1" style="padding: 0">
                                <label for="firstName">Мама: {{$itemPeople->title}}</label>
                                <input name="mum" value="{{$itemPeople->id}}" style="display: none">
                            </div>
                        </div>
                        <div class="row m-2">
                            <div class="mb-1" style="padding: 0">
                        ...
                        <div class="row m-2">
                            <div class="mb-1" style="padding: 0; width: 100%">
                                <label for="firstName">Папа:</label>
                                <select class="form-control" name="dad" multiple="multiple">
                                    <option selected value="">Неизвесто</option>
                                    @foreach ($peopledad as $ItemPeopleDad)
                                        <option  value="{{ $ItemPeopleDad->id }}">{{ $ItemPeopleDad->title }}</option>
                                    @endforeach
                                </select>
