                ...
                <header class="header">
                    ...
                    <div class="top-menu">
                        <ul>
                            ...
                            <li>
                                <a href="/people/{{$people->id}}/albumfoto/{{$fotoname->id}}/edit">
                                    <span class="icon ion-android-list"></span>
            ...
            <div class="card-inner active" id="about-card">
                <div class="card-wrap" style="">
                    ...
                    <div class="content about">
                        <!-- title -->
                        <div class="title"><span class="first-letter">Фото {{$fotoname->name}}</span></div>
                        <!-- content -->
                        <div class="row">
                            <div class="col-lg-12 col-d-12 col-t-12 col-m-12 border-line-v">
                                @foreach($foto as $itemPhoto)
                                <div class="box-item" style="width: 50%; float: left">
                                    <div class="image">
                                        <a data-fancybox="gallery" href="{{ asset('images/photos') }}/{{$itemPhoto->url}}">
                                            <img src="{{ asset('images/photos') }}/{{$itemPhoto->url}}" alt="">
                                            <span class="date" style="padding: 10px 10px 10px 10px; width: auto; height: 33px;">{{$itemPhoto->name}}</span>
                                        </a>
                                    </div>
                                </div>
                                @endforeach
